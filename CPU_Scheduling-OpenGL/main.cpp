...
char line1[] = {"NMAM Institute of Technology"};
char line2[] = {"Computer Science Department"};
char line3[] = {"   Computer Graphics project"};
char line4[] = {"Topic: CPU Scheduling Algorithm"};
char line5[] = {"     Prathvik Shervegar    : 4NM18CS119"};
char line6[] = {"Pratik Chandra Chandragiri : 4NM18CS120"};
char line7[] = {"(Press enter to go to the main page)"};
char op[] = {"Options:"};
char op1[] = {"1. First Come First Serve (FCFS)"};
char op2[] = {"2. Round Robin (RR)"};
char op3[] = {"3. Shortest Job First (SJF) - (Non-Preemptive)"};
